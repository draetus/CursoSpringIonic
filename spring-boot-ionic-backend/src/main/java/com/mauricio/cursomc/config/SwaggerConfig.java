...
public class SwaggerConfig {
	...
	Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.mauricio.cursomc.resources")).paths(PathSelectors.any())
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				"https://www.udemy.com/terms", new Contact("Mauricio Farias", "", "fariasjrmauricio@gmail.com"),
